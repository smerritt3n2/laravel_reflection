                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="creates">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="company" type="company" class="form-control @error('company') is-invalid @enderror" name="company" value="{{ old('company') }}" required autocomplete="company" autofocus>
